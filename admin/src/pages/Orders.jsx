    ...
    <div>
      ...
      <div>
        {orderData.map((order, index) => (
          <div className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-3 items-center border-2 border-gray-200 p-5 md:p-8 my-3 text-xs text-gray-700 " key={index}>
